    ...
    <div className="bg-gradient-to-r from-red-600 to-red-400 h-60">
      <div className=" p-5">
        ...
        <div className="flex mx-20 my-5 font-bold">
          <button
            type="submit"
            className="h-16  px-3 py-2  hover:cursor-pointer mr-5 text-white"
          >
           Continue your search
          </button>
          <button
            type="submit"
            className="h-16 px-3 py-2  hover:cursor-pointer border-2 border-white text-white rounded-xl hover:bg-gray-500"
          >
